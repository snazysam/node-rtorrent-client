...
class Client {
  ...
  addCall( method, hash=undefined, ...params ) {
    ...
    if ( this.context == "sub" )
      return this.addSub( method, hash, ...params );
    else
      return this.addPrimary( method, ...params );
  }
  ...
  addSub( method, ...params ) {
    ...
    if ( params.length > 1 )
      throw new Error( "Sub-command may not have more than 1 argument" );
    // Sub-commands always follow a method=arg1,args2... structure over RPC.
